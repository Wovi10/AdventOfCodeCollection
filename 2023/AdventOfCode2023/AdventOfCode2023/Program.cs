...
// await new Day03().Run("03", "Gear Ratios");
// await new Day04().Run("04", "Scratchcards");
// await new Day05().Run("05", "If You Give A Seed A Fertilizer");
// await new Day06().Run("06", "Wait For It");
// await new Day07().Run("07", "Camel Cards");
...
// await new Day20().Run("20", "Pulse Propagation");
await new Day21().Run("21", "Step counter", PartsToRun.Part2);