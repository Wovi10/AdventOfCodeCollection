...
public static class Day01
{
    ...
    {
        return GetCalibrationList(regexMatch).Sum();
    }
    ...
    private static List<int> GetCalibrationList(string regex = @"\d")
    {
        ...
        var tempLast = tempLine.Select(inputLine => new {inputLine, lastNumber = Regex.Match(inputLine, regex)}).First().lastNumber;
        ...
        return InputFile.Split("\n")
            ...
            .Select(t => new {t, lastNumber = Regex.Match(t.inputLine, regex)})
    ...
    private static readonly IEnumerable<string> ExampleInput = new[]
    {
        "two1nine",
        "eightwothree",
        "abcone2threexyz",
    ...
    private static readonly IEnumerable<string> InputList = new[]
    {
